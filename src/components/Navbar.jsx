  ...
  services: [
    {
      ...
      items: [
        ...
        { name: 'Meta/Facebook Ads', path: '/meta-ads-agency-in-chennai-magdio' },
        { name: 'Social Media Marketing', path: '/social-media-marketing-agency-in-chennai-magdio' },
        { name: 'Performance Marketing', path: '/best-performance-marketing-agency-in-chennai-magdio' },
        { name: 'WhatsApp Marketing', path: '/whatsapp-marketing-services-in-chennai-magdio' },
        { name: 'YouTube Ads', path: '/youtube-marketing-agency-chennai-magdio' },
