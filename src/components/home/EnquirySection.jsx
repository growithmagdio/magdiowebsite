      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        >
          <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="relative">
              <select className="input-field w-full text-white/70 appearance-none cursor-pointer bg-transparent">
                <option value="" disabled selected className="bg-[#06071a] text-white/70">Service Interested In</option>
